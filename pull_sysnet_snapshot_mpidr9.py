...
if rank==0:
    ...
    chcks = glob(f'/global/cscratch1/sd/arosado/test_sysnet/{region}_256/model_*/snapshot_*.pth.tar')
    templates = ft.read(f'/global/cscratch1/sd/arosado/nlrg_features_{region}_256.fits')    

   # nside=1024
    oudir = f'/global/cscratch1/sd/arosado/test_sysnet/{region}_256/windows'
