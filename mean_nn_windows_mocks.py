...
t = ''#'_test1'
nside = 256
windows = glob(f'/global/cscratch1/sd/arosado/test_sysnet/prepared_contaminated_mocks/windows_clean{t}/nnwindow_*.hp{nside}.fits')
...
output_path = f'/global/cscratch1/sd/arosado/test_sysnet/prepared_contaminated_mocks/windows_clean{t}/nn-weights.hp{nside}.fits'
